...
We are aware of the fact that f1 score, precision and recall of our model on the train, validation and test set are quite high. This may be because there are underlying linear relationships between different columns and the target.
