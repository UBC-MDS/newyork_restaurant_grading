...
```{r '60%', out.height = '25%', fig.cap = 'Table 2.1. Mean train and validation scores from each model.'}
...
```{r out.width = '100%', fig.cap = 'Table 2.3. Mean train and cross-validation scores (5-fold) for balanced logistic regression, optimizing F1 score.'}
...
```{r out.width = '30%', out.height = '25%', fig.cap='Table 2.4. Mean and standard deviation of train and validation scores for the balanced logistic regression model.\nParameters: C = 0.024947, max_features = 130, max_categories = 47.'}
...
```{r out.width = '50%', out.height = '25%', fig.cap = 'Table 2.5. Classification report on the test set'}
